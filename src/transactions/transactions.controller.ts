...
export class TransactionsController {
    ...
    public async findCompanyById(@Param() params: GetTransactionParams): Promise<any> {
        const contactItem = await this.transactionsService.findTransactionById(params.id);
        return (contactItem);
    }
    ...
    public async create(
        ...
        const transaction = await this.transactionsService.create(origin, contactsDto);
    ...
    async getCompanyByUserId(
        ...
        return this.transactionsService.getTransactionsByUserId(params.id, pageOptionsDto);
    }
    ...
    async updateUserTransactionStatus(
        ...
        const updatedTransaction = await this.transactionsService.updateUserTransactionStatus(id, status, amount, currency);
