...
export class NotificationsController {
  ...
  public async getByNotificationId(
    @Param() params: GetNotificationParams,
  ): Promise<IResponseNotifications> {
    const notificationItem = await this.notificationsService.findOneById(
      params.id,
    );
  ...
  async unreadNotificationByUserId(
    ...
    return this.notificationsService.unreadNotificationByUserId(
      params.id,
      pageOptionsDto,
    );
  }
  ...
  async updateStatus(
    ...
    const notificationItem = await this.notificationsService.updateStatus(
      Number(params.id),
    );
    return ResponseNotificationMapper.map(notificationItem);
  }
  ...
  async readAllNotificationByUserId(
    ...
    return await this.notificationsService.readAllNotificationByUserId(
      Number(params.id),
    );
  }
  ...
  async getNotificationsByResourceId(
    ...
    return this.notificationsService.getNotificationsByResourceId(
      params.id,
      pageOptionsDto,
    );
  }
  ...
  async getNotificationsByResourceType(
    ...
    return this.notificationsService.getNotificationsByResourceType(
      params.type,
      pageOptionsDto,
    );
  }
  ...
  public async deleteByNotificationId(
    ...
    const notificationItem =
      await this.notificationsService.deleteByNotificationId(Number(params.id));
    return ResponseNotificationMapper.map(notificationItem);
  }
}
