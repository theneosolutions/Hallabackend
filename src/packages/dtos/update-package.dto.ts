...
export abstract class UpdatePackageDto {
  ...
  @IsOptional()
  @Length(3, 106)
  @ValidateIf((o: UpdatePackageDto) => !isUndefined(o.name) || isNull(o.name))
  public name?: string;
  ...
  @Length(3, 106)
  @ValidateIf(
    (o: UpdatePackageDto) => !isUndefined(o.subHeading) || isNull(o.subHeading),
  )
  ...
  @IsOptional()
  @IsNumber()
  @ValidateIf((o: UpdatePackageDto) => !isUndefined(o.price) || isNull(o.price))
  public price?: number;
  ...
  @Length(3, 106)
  @ValidateIf(
    (o: UpdatePackageDto) => !isUndefined(o.status) || isNull(o.status),
  )
  ...
  @IsString()
  @Length(0, 106)
  @ValidateIf((o: UpdatePackageDto) => !isUndefined(o.notes) || isNull(o.notes))
  public notes?: string;
