...
export class CHANGEINVITEEVENTSRELATIONS1709821339270
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE \`event_invitess_contacts\` ADD \`numberOfScans\` decimal(6,2) NULL DEFAULT '0.00'`,
    );
    await queryRunner.query(
      `ALTER TABLE \`event_invitess_contacts\` ADD \`numberOfGuests\` decimal(6,2) NULL DEFAULT '0.00'`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE \`contacts\` CHANGE \`code\` \`code\` varchar(255) NOT NULL DEFAULT '918ae1cd-259d-4f13-94a6-e0b4edaf10a8'`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE \`event_invitess_contacts\` ADD PRIMARY KEY (\`eventId\`, \`contactsId\`)`,
    );
    await queryRunner.query(
      `CREATE INDEX \`IDX_81ee7cc114f6a7a10cb5d847cd\` ON \`event_invitess_contacts\` (\`contactsId\`)`,
    );
    await queryRunner.query(
      `CREATE INDEX \`IDX_2df87041f184159afec0885f3f\` ON \`event_invitess_contacts\` (\`eventId\`)`,
    );
    await queryRunner.query(
      `ALTER TABLE \`event_invitess_contacts\` ADD CONSTRAINT \`FK_81ee7cc114f6a7a10cb5d847cd0\` FOREIGN KEY (\`contactsId\`) REFERENCES \`contacts\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE \`event_invitess_contacts\` ADD CONSTRAINT \`FK_2df87041f184159afec0885f3f7\` FOREIGN KEY (\`eventId\`) REFERENCES \`events\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE \`event_invitess_contacts\` CHANGE \`contactsId\` \`contactsId\` int NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE \`event_invitess_contacts\` DROP PRIMARY KEY`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE \`events\` CHANGE \`code\` \`code\` varchar(255) NOT NULL DEFAULT 'dc64296a-a2a0-447c-8193-5e3605acc4ed'`,
    );
    await queryRunner.query(
      `ALTER TABLE \`contacts\` CHANGE \`code\` \`code\` varchar(255) NOT NULL DEFAULT '29785274-545e-4528-9387-29601f8ffd62'`,
    );
    await queryRunner.query(
      `ALTER TABLE \`contacts\` CHANGE \`code\` \`code\` varchar(255) NOT NULL DEFAULT '29785274-545e-4528-9387-29601f8ffd62'`,
    );
    await queryRunner.query(
      `ALTER TABLE \`users\` CHANGE \`credentials_updatedAt\` \`credentials_updatedAt\` int NOT NULL DEFAULT '1709821049'`,
    );
    await queryRunner.query(
      `ALTER TABLE \`users\` CHANGE \`credentials_passwordUpdatedAt\` \`credentials_passwordUpdatedAt\` int NOT NULL DEFAULT '1709821049'`,
    );
    await queryRunner.query(
      `ALTER TABLE \`event_invitess_contacts\` DROP PRIMARY KEY`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE \`event_invitess_contacts\` ADD \`status\` varchar(255) NOT NULL DEFAULT 'invited'`,
    );
