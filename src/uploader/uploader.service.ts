...
export class UploaderService {
    ...
    constructor() {
        ...
        this.bucketData = {
            ...
            url: `https://${process.env.BUCKET_NAME}.s3.${`${process.env.BUCKET_REGION}.${process.env.BUCKET_HOST}.com`}/`,
        };
    ...
    public async uploadImage(
        ...
        try {
            return await this.uploadFile(
                userId,
                file.buffer?.length < 50000 ? file.buffer : await UploaderService.compressImage(
                    file.buffer,
                    ratio,
                ),
    ...
    public async uploadVideo(
        ...
        const { mimetype } = file;
        console.log("🚀 ~ file: uploader.service.ts:147 ~ UploaderService ~ file:", file)
        console.log("🚀 ~ file: uploader.service.ts:147 ~ UploaderService ~ mimetype:", mimetype)
